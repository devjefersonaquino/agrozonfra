...
@ControllerAdvice(basePackages = "br.com.agrozonfra.controller")
public class ClienteControllerAdvice {

    @ResponseBody
    @ExceptionHandler(ClienteNotFoundException.class)
    public ResponseEntity<MessageExceptionHandler> clienteNotFound(ClienteNotFoundException clienteNotFoundException){
